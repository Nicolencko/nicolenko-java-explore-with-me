...
public class RequestServiceImpl implements RequestService {
    ...
    public ParticipationRequestDto saveRequest(Long userId, Long eventId) {
        ...
        if (requestRepository.getRequestByUserIdAndEventId(userId, eventId) != null ||
            ...
            throw new ConflictException("Недопустимые условия запроса на участие");
        }
        ...
        Request requestToSave = requestRepository.saveAndFlush(newRequest);
        return requestMapper.mapToDto(requestToSave);
    }
